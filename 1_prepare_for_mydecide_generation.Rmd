...
```{r}
#load dataframe
user_db <- read_csv("data_personal/data-2022-08-04.csv") #<-- update this to be the latest set of users
...
#load in data
records_data <- readRDS(paste0("data/species_records_",Sys.Date(),".RDS"))
...
for (i in 1:n_emails){
  ...
  markdown_params <- 
    list(
        ...
        records_data_location = paste0("data/species_records_",Sys.Date(),".RDS"),
