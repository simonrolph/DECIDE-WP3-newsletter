...
knitr::opts_chunk$set(echo = F,warning = F,message = FALSE, fig.align = 'center') # one could add this for ailigning all images to the centre
...
# VISUALISE
if(personalised){
  p("In ",month_name_got_personal_records_from,", your highest recording priority records was from your visit to ",place_name," where you recorded ",top_visit$n_species," species. One of the species you recorded was",em(paste0(top_visit$scientific_name,"."))) %>% print() #if a p() function (or equivalent) is in an if statement you need to print it using print()
} else {
