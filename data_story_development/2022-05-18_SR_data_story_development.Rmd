...
# 
if(personalised){
  p("In",month_name_got_personal_records_from,"you recorded in ", strong(nrow(high_priority_records)) ,"different 100x100m locations and recorded a total of ",strong(n_species)," species across these sites. Records at these sites fill gaps in our understanding of species’ distributions. Here are the ",nrow(high_priority_records)," locations with the higest number of species you recorded.") %>% print()
...
ds2_map_2 <- ggplot() +
  ...
  layer_spatial(central_point_sf,col = "green",size = 10)+
  fixed_plot_aspect() + 
  theme(axis.text.x=element_blank(), #remove x axis labels
        axis.ticks.x=element_blank(), #remove x axis ticks
        axis.text.y=element_blank(),  #remove y axis labels
