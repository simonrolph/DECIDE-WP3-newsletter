...
place_name_fun <- function(lat,lon){
  ...
  if(place_name == "in " ){
    ...
    if(distance_from_home<5000){
      ...
      place_name <- "outside your local area"
    }
...
if(params$data_story != 5){
  ...
  if(personalised){
     ...
     p("This is the final MyDECIDE email. We will send a final questionnaire about your MyDECIDE experience in a follow-up email.") %>% print()
