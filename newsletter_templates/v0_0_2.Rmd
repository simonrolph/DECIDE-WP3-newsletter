...
sum(records_data$observed_by==41900)
...
if(personalised){
   ...
   p(paste0("Welcome to your MyDECIDE email. Here is your data story based on your butterfly recording from past 30 days. This includes the period from ",format(as.Date(start_date),"%d/%m/%Y") ," to ",format(as.Date(end_date),"%d/%m/%Y") ,".")) %>% print()
   
} else {
  tags$h1(paste0("Hello ",params$name,"!")) %>% print()
  p(paste0("Welcome to your MyDECIDE newsletter. Here is your data story based on community recording over the past 30 days. This includes the period from ",format(as.Date(start_date),"%d/%m/%Y") ," to ",format(as.Date(end_date),"%d/%m/%Y") ,".")) %>% print()
}
...
if(params$data_story == 1){
  ...
  if (personalised){
    ...
    ds1_data <- community_data_this_month %>% filter(in_home_range)
  ...
  if(personalised){
    ...
    p(
      ...
      "a visit to ",
      place_name,
      "was the highest DECIDE recording priority visit this month. On this visit",
       top_visit$n_species,
       ...
       " In total, ",
      n_records_of_featured_sp,
      " records of this species were made this month by online recorders."
    ) %>% print() #if a p() function (or equivalent) is in an if statement you need to print it using print()
  }
...
if(params$data_story == 2){
  ...
  p("Nearby to the locations which had the most species recorded there are some high recording priority locations which are in need of records, why not go to one of these next time you record?") %>% print()
...
if (params$data_story == 3){
  ...
  print(ds3_map)
  p(em("This month's records from the DECIDE community"),style="font-size:10px;text-align:center;") %>% print()
...
if(params$data_story == 4){
  ...
  if(personalised){ #set colour = target_user to highlight the personalisation
    ...
    p(paste0("Recording has an impact: species records improve our understanding of the distribution of species. Every visit increases the impact score of recorders but recording in areas with high DECIDE scores boosts impact even more! Look at the impact of 100 recorders from 2022.")) %>% print()
  ...
  if(personalised){
    ...
    p(paste0("Continue to build your impact by planning a visit near the last place you recorded: ",place_name,". Get suggestions for high DECIDE priority areas to record to most effectively increase your impact score.")) %>% print()
    ...
    p("Continue to build your impact by planning a visit in the area you provided on sign-up. Get suggestions for high DECIDE priority areas to record to most effectively increase your impact score.") %>% print()
