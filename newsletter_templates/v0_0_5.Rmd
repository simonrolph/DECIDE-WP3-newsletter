...
if(params$try_personalised){
  ...
  community_data <- combined_data <- records_data
...
if(params$data_story != 5){
  ...
  if(personalised){
     ...
     p(paste0("Welcome to your MyDECIDE email. Here is the impact of your butterfly recording from past 30 days. This includes the period from ",format(as.Date(start_date),"%A %d %B") ," to ",format(as.Date(end_date),"%A %d %B") ,".")) %>% print()
     
  } else {
    tags$h1(paste0("Hello ",params$name,"!")) %>% print()
    p(paste0("Welcome to your MyDECIDE email. Here is some information about the impact of butterfly recorders in your area over the past 30 days. This includes the period from ",format(as.Date(start_date),"%A %d %B") ," to ",format(as.Date(end_date),"%A %d %B") ,".")) %>% print()
  }
...
if(params$data_story == 2){
  ...
  if (personalised){
    p(paste0("Close to where you recorded ",high_priority_records$n_species[1]," species ",place_name," there are some high recording priority locations which are in need of records, why not consider going to one of these next time you record?")) %>% print()
  } else {
    p(paste0("Close to where ",high_priority_records$n_species[1]," were recorded ",place_name," there are some high recording priority locations which are in need of records, why not consider going to one of these next time you record?")) %>% print()
  }
  ...
  decide_button(paste0("https://dwptwo-mydecide.datalabs.ceh.ac.uk?lat=",
                  ...
                  "&lon=",
                  central_point_long,
                  "&score=true&zoom=13&ds=2&suggestions=true")) %>% print()
...
if (params$data_story == 3){
  if(personalised){
    h3("Making a different together") %>% print()
  } else {
    h3("Making a different together") %>% print()
  }
  #DATA STORY 3
  ...
  # VISUALISE
  p("Wildlife recording is a collective effort and by working together we can better understand species distributions. A total of", strong(prettyNum(nrow(community_data_this_month),big.mark=",",scientific=FALSE)), "butterflies records were made online in the past 30 days across Great Britain. Take a look at where people have been recording near where you record:") %>% print()
  ...
  if(personalised){
    ...
    ds3_map <-ggplot()+
      annotation_map_tile(type = "cartolight", zoomin = -1,progress="none")+
      layer_spatial(invisible_circle(params$home_lon,
  ...
  p(em("Records from the past 30 days from the recording community"),style="font-size:10px;text-align:center;") %>% print()
...
if(params$data_story == 4){
  ...
  if(personalised){
    ...
    decide_button(paste0("https://dwptwo-mydecide.datalabs.ceh.ac.uk?lat=",
                    ...
                    "&zoom=13&ds=3&score=true&suggestions=true")) %>% print()
    ...
    decide_button(paste0("https://dwptwo-mydecide.datalabs.ceh.ac.uk?lat=",
                    ...
                    "&lon=",
                    params$home_lon,
                    "&zoom=12&ds=3&score=true&suggestions=true")) %>% print()
  }
