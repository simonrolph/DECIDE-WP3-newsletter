...
decide_button <- function(url = ""){
  div(style="margin: auto;width: 100%;text-align: center;",
      a("Give feedback and visit the DECIDE Recorder Tool", 
        href=paste0("https://dwptwo-mydecide.datalabs.ceh.ac.uk?lat=",
                    params$home_lat,
                    "&lon=",
                    params$home_lon,
...
if(params$data_story == 2){
  ...
  if(personalised){
    ...
    p("In the past 30 days you recorded in ", strong(nrow(all_records)) ,"different 100x100m locations near you and recorded a total of ",strong(n_species)," species across these sites. Records at these sites fill gaps in our understanding of species’ distributions. Here are the ",nrow(high_priority_records)," locations with the highest number of species you recorded.") %>% print()
...
if(params$data_story == 4){
  h3("Your impact on improving our understanding of species distributions") %>% print()
  #DATA STORY 4
  ...
  extra_rows <- data.frame(
    grid_square = c("1","2"),
    observed_on = as.Date(c(paste0(2022,"-04-01"),toString(end_date))),
